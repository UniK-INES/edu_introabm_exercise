...
class PDAgent(CellAgent):
    ...
    def step(self):
        ...
        if self.cell.coordinate == self.model.focalpos and self.model.printneighbourorder:
    ...
    def increment_score(self):
        ...
        if self.model.activation_order == "Simultaneous":
            ...
            if self.cell.coordinate == self.model.focalpos and self.model.printneighbourscore:
