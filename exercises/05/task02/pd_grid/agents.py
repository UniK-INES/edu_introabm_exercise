...
class PDAgent(CellAgent):
    ...
    def step(self):
        ...
        if self.model.printneighbourorder and self.cell.coordinate == self.model.focalpos:
        ...
        if self.model.printneighbourorder and self.cell.coordinate == self.model.focalpos:
            logger_neighbours.info("Neighbours of {0:2.0f}/{1:2.0f}".format(
                self.cell.coordinate[0], self.cell.coordinate[1]) + ": " + 
                  "".join(["({:1.0f}/{:1.0f}".format(agent.cell.coordinate[0], 
                                                     agent.cell.coordinate[1]) + 
    ...
    def increment_score(self):
        ...
        if self.model.printneighbourscore and self.cell.coordinate == self.model.focalpos:
